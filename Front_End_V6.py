...
food_name_label1.grid(row=5, column=1, padx=(90, 0), pady=5, sticky='w')
calorie_label1 = Label(frame, text="Calories", font='Arial 14')
calorie_label1.grid(row=5, column=1, padx=(450, 0), pady=5)
food_name_label2 = Label(frame, text="Food Name", font='Arial 14')
food_name_label2.grid(row=5, column=3, padx=(10, 250), pady=5, sticky='w')
